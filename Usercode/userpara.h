...
extern uint16_t u_dac_value1;     // DAC1 示波器打印变量,用户自行赋值
extern uint16_t u_dac_value2;     // DAC2 示波器打印变量,用户自行赋值
extern uint16_t system_dac_print; // DAC 打印,用户自行定义DAC打印的变量
...
extern alpha_beta_t Drive_ialphabeta; // 驱动电机 alphabeta 轴电流(原始值)
extern dq_t Drive_idq;                // 驱动电机 dq 轴电流(原始值)

extern LPF_t Drive_ialpha_filter;      // 驱动电机 alpha 轴电流低通滤波器
extern LPF_t Drive_ibeta_filter;       // 驱动电机 beta 轴电流低通滤波器
extern alpha_beta_t Drive_ialphabetal; // 驱动电机 alphabeta 轴低频电流
...
extern Slope_t Drive_speed_slope; // 速度斜坡指令模块结构体
extern float drive_speed_krise;   // 速度斜坡指令斜率
...
extern Slope_t Load_iq_slope; // 负载电流斜坡指令模块结构体
extern float load_iq_krise;   // 电流斜坡指令斜率
